...
export default function ProfileSection() {
  ...
  return (
    <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
      <div className="relative z-0 h-35 overflow-hidden md:h-65">
        <Image
          src={data.coverPhoto}
          alt="profile cover"
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-1 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-[176px] sm:p-3">
        ...
        <div className="mt-4">
          ...
          <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-2 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
            ...
            <div className="flex flex-col items-center justify-center gap-2 px-4 xsm:flex-row">
              <span className="text-lg font-medium text-dark dark:text-white">
                -12
              </span>
          ...
          <div className="mx-auto max-w-[620px]">
            <h4 className="text-xl font-medium text-dark dark:text-white">
              Minha meta
            </h4>
