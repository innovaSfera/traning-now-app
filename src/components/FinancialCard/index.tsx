  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex w-full flex-col items-center gap-8">
        {/* Cartão */}
        <div className="relative h-48 w-full rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-800 p-6 text-white shadow-2xl dark:from-indigo-700 dark:to-purple-900 xl:w-125">
          <div className="absolute right-5 top-3 text-2xl font-semibold">
            VISA
          </div>
          ...
          <div className="mt-6 flex justify-between text-sm">
            <div>
              <div className="text-md uppercase text-gray-300">Nome completo</div>
              <div>{cardHolder || "Seu Nome"}</div>
            </div>
            <div>
              <div className="text-md uppercase text-gray-300">Validade</div>
              <div>
        ...
        {/* Formulário */}
        <form
          className="w-full max-w-full space-y-4 rounded-2xl bg-white p-6 shadow-xl transition-colors dark:bg-gray-800 xl:max-w-180"
