...
export function Academy(props: PropsType) {
  return (
    <svg
      width="24"
      height="24"
...
export function Fingerprint(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_19644_14)">
        <path
          d="M6.33594 23.115C7.43396 20.9042 8.00351 18.4685 7.99969 16C7.99758 14.7997 8.26623 13.6144 8.78564 12.5323C9.30506 11.4502 10.0618 10.4991 10.9997 9.75"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M11.6009 20C11.1738 22.1026 10.4089 24.1221 9.33594 25.98"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M15 8.06223C15.3318 8.02157 15.6657 8.00112 16 8.00098C18.1217 8.00098 20.1566 8.84383 21.6569 10.3441C23.1571 11.8444 24 13.8792 24 16.001C23.9991 17.3382 23.9156 18.6741 23.75 20.001"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M22.9922 24C22.8022 24.74 22.5864 25.4692 22.3447 26.1875"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export function Cloud(props: PropsType) {
  return (
    ...
    >
      <path
        d="M15.3891 7.61091C13.2412 5.46303 9.7588 5.46303 7.61091 7.61091C6.12222 9.09961 5.66533 11.2294 6.24026 13.1116C5.38283 12.8466 4.41095 13.0535 3.73223 13.7322C2.75592 14.7085 2.75592 16.2915 3.73223 17.2678C4.22039 17.7559 4.86019 18 5.5 18H17.5C18.3957 18 19.2915 17.6583 19.9749 16.9749C21.3417 15.608 21.3417 13.392 19.9749 12.0251C19.159 11.2093 18.0405 10.8804 16.9807 11.0385C16.8761 9.78847 16.3455 8.56737 15.3891 7.61091Z"
        fillRule="evenodd"
        clipRule="evenodd"
        fill=""
      ></path>
